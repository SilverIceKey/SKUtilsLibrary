...
class GlideEngine: ImageEngine {
     ...
     */
    override fun loadImage(@NonNull context: Context, @NonNull url: String,
     ...
     */
    override fun loadFolderImage(@NonNull context: Context, @NonNull url: String, @NonNull imageView: ImageView) {
        Glide.with(context)
                .asBitmap()
                .load(url)
                .override(180, 180)
     ...
     * @param imageView 承载图片ImageView
     */
    override fun loadAsGifImage(@NonNull context: Context, @NonNull url: String,
                       @NonNull imageView: ImageView) {
        Glide.with(context)
                .asGif()
                .load(url)
