...
- ```2021/06/11``` 删除第三方的工具包，尝试开始编写自用工具包只包含本人项目中使用的那部分，编写类型还是借鉴第三方工具包的，修复httplogger日志拦截器不工作的问题，添加readme中文接口说明书，完善部分方法
- ```2021/06/12``` 新增编码和加密类已经媒体数据处理类，待完善
- ```2021/06/29``` 修改网络请求配置类，新增加密类